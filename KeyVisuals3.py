...
sns.lineplot(data=monthly_cost_trend, x=monthly_cost_trend['Month'].astype(str), y='Cost', marker='o')
...
plt.figure(figsize=(10, 6))
sns.barplot(data=service_cost_sorted, x='Service', y='Cost', hue='Service', palette='viridis', legend=False)
...
plt.figure(figsize=(10, 6))
sns.barplot(data=instance_type_cost_sorted, x='Instance_Type', y='Cost', hue='Instance_Type', palette='magma', legend=False)
...
plt.figure(figsize=(10, 6))
sns.barplot(data=environment_cost_sorted, x='Environment', y='Cost', hue='Environment', palette='cividis', legend=False)
